...
export type StorageHash =
  StorageHashBase<'0ff14c1c5cbf4821c1b908eaa319002aa65939655a7c5102e5ded9fb186ff1ef'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly DeviceRegistrationToken: {
      readonly id: CodecTypes['pg/int4@1']['output'];
      readonly tokenHash: CodecTypes['pg/text@1']['output'];
      readonly userId: CodecTypes['pg/int4@1']['output'];
      readonly expiresAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
    ...
    readonly PpqcheckTransaction: {
      readonly id: CodecTypes['pg/int4@1']['output'];
      readonly type: 'CREDIT' | 'CERTIFICATE_COST' | 'REFUND' | 'ADJUSTMENT';
      ...
      readonly fundingStatus: 'PENDING' | 'COMPLETED' | 'FAILED' | null;
      readonly externalOrderId: CodecTypes['pg/text@1']['output'] | null;
      readonly ppqDepositId: CodecTypes['pg/text@1']['output'] | null;
      readonly ppqDepositAddress: CodecTypes['pg/text@1']['output'] | null;
      readonly ppqDepositAmount: CodecTypes['pg/numeric@1']['output'] | null;
      readonly ppqDepositNetwork: CodecTypes['pg/text@1']['output'] | null;
      readonly ppqDepositExpiresAt: CodecTypes['pg/timestamptz-temporal@1']['output'] | null;
      readonly paymosWithdrawalId: CodecTypes['pg/text@1']['output'] | null;
      readonly paymosWithdrawalStatus: CodecTypes['pg/text@1']['output'] | null;
    };
    readonly Session: {
      readonly id: CodecTypes['pg/int4@1']['output'];
    ...
    readonly SyncCredit: {
      readonly id: CodecTypes['pg/int4@1']['output'];
      readonly ppqAmount: CodecTypes['pg/numeric@1']['output'];
      readonly ppqCoverage: CodecTypes['pg/numeric@1']['output'];
    };
    ...
    readonly TokenPurchase: {
      ...
      readonly amount: CodecTypes['pg/numeric@1']['output'];
      readonly paymosOrderId: CodecTypes['pg/text@1']['output'];
      readonly status: 'PENDING' | 'PAID' | 'PAID_FUNDING';
    };
    readonly TokenTransaction: {
      readonly id: CodecTypes['pg/int4@1']['output'];
      readonly userId: CodecTypes['pg/int4@1']['output'];
      readonly amount: CodecTypes['pg/int4@1']['output'];
      readonly type: 'CERTIFICATE' | 'REFUND';
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly PpqcheckTransaction: {
      ...
      readonly ppqDepositId: CodecTypes['pg/text@1']['input'] | null;
      readonly ppqDepositAddress: CodecTypes['pg/text@1']['input'] | null;
      readonly ppqDepositAmount: CodecTypes['pg/numeric@1']['input'] | null;
      readonly ppqDepositNetwork: CodecTypes['pg/text@1']['input'] | null;
      readonly ppqDepositExpiresAt: CodecTypes['pg/timestamptz-temporal@1']['input'] | null;
      readonly paymosWithdrawalId: CodecTypes['pg/text@1']['input'] | null;
      readonly paymosWithdrawalStatus: CodecTypes['pg/text@1']['input'] | null;
    };
    readonly Session: {
      readonly id: CodecTypes['pg/int4@1']['input'];
    ...
    readonly SyncCredit: {
      readonly id: CodecTypes['pg/int4@1']['input'];
      readonly ppqAmount: CodecTypes['pg/numeric@1']['input'];
      readonly ppqCoverage: CodecTypes['pg/numeric@1']['input'];
    };
    readonly TokenPackage: {
      readonly id: CodecTypes['pg/int4@1']['input'];
      readonly name: CodecTypes['pg/text@1']['input'];
    ...
    readonly TokenPurchase: {
      ...
      readonly amount: CodecTypes['pg/numeric@1']['input'];
      readonly paymosOrderId: CodecTypes['pg/text@1']['input'];
      readonly status: 'PENDING' | 'PAID' | 'PAID_FUNDING';
    };
    readonly TokenTransaction: {
      readonly id: CodecTypes['pg/int4@1']['input'];
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly deviceRegistrationToken: {
              ...
              indexes: readonly [
                {
                  readonly name: 'deviceRegistrationToken_userId_idx_a489d58a';
                  readonly prefix: 'deviceRegistrationToken_userId_idx';
                  readonly columns: readonly ['userId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'deviceRegistrationToken';
                    readonly columns: readonly ['userId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly ppqcheckTransaction: {
              columns: {
                ...
                readonly ppqDepositId: {
                  readonly nativeType: 'text';
                  readonly codecId: 'pg/text@1';
                  readonly nullable: true;
                };
                readonly ppqDepositAddress: {
                  readonly nativeType: 'text';
                  readonly codecId: 'pg/text@1';
                  readonly nullable: true;
                };
                readonly ppqDepositAmount: {
                  readonly nativeType: 'numeric';
                  readonly codecId: 'pg/numeric@1';
                  readonly nullable: true;
                };
                readonly ppqDepositNetwork: {
                  readonly nativeType: 'text';
                  readonly codecId: 'pg/text@1';
                  readonly nullable: true;
                };
                readonly ppqDepositExpiresAt: {
                  readonly nativeType: 'timestamptz';
                  readonly codecId: 'pg/timestamptz-temporal@1';
                  readonly nullable: true;
                };
                readonly paymosWithdrawalId: {
                  readonly nativeType: 'text';
                  readonly codecId: 'pg/text@1';
                  readonly nullable: true;
                };
                readonly paymosWithdrawalStatus: {
                  readonly nativeType: 'text';
                  readonly codecId: 'pg/text@1';
                  readonly nullable: true;
                };
            ...
            readonly tokenPurchase: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['paymosOrderId'] }];
              indexes: readonly [
                {
          ...
          readonly valueSet: {
            ...
            readonly PpqcheckFundingStatus: {
              readonly kind: 'valueSet';
              readonly values: readonly ['PENDING', 'COMPLETED', 'FAILED'];
            };
            readonly PpqcheckTransactionType: {
              readonly kind: 'valueSet';
              readonly values: readonly ['CREDIT', 'CERTIFICATE_COST', 'REFUND', 'ADJUSTMENT'];
            };
            readonly TokenPurchaseStatus: {
              readonly kind: 'valueSet';
              readonly values: readonly ['PENDING', 'PAID', 'PAID_FUNDING'];
            };
            readonly TokenTransactionType: {
              readonly kind: 'valueSet';
              readonly values: readonly ['CERTIFICATE', 'REFUND'];
            };
          };
        };
      };
...
> & {
  ...
  readonly roots: {
    ...
    readonly deviceRegistrationToken: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'DeviceRegistrationToken';
    };
    readonly deviceModelCache: {
      readonly namespace: 'public' & NamespaceId;
    ...
    readonly paymosWebhookEvent: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'PaymosWebhookEvent';
    };
    readonly tokenTransaction: {
      readonly namespace: 'public' & NamespaceId;
      ...
      readonly public: {
        readonly models: {
          ...
          readonly DeviceRegistrationToken: {
            ...
            readonly storage: {
              readonly table: 'deviceRegistrationToken';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly tokenHash: { readonly column: 'tokenHash' };
          ...
          readonly PaymosWebhookEvent: {
            ...
            readonly relations: Record<string, never>;
            readonly storage: {
              readonly table: 'paymosWebhookEvent';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
          ...
          readonly PpqcheckTransaction: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly fundingStatus: { readonly column: 'fundingStatus' };
                readonly externalOrderId: { readonly column: 'externalOrderId' };
                readonly ppqDepositId: { readonly column: 'ppqDepositId' };
                readonly ppqDepositAddress: { readonly column: 'ppqDepositAddress' };
                readonly ppqDepositAmount: { readonly column: 'ppqDepositAmount' };
                readonly ppqDepositNetwork: { readonly column: 'ppqDepositNetwork' };
                readonly ppqDepositExpiresAt: { readonly column: 'ppqDepositExpiresAt' };
                readonly paymosWithdrawalId: { readonly column: 'paymosWithdrawalId' };
                readonly paymosWithdrawalStatus: { readonly column: 'paymosWithdrawalStatus' };
              };
            };
          };
          readonly Session: {
          ...
          readonly SyncCredit: {
            ...
            readonly relations: Record<string, never>;
            readonly storage: {
              readonly table: 'syncCredit';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly ppqAmount: { readonly column: 'ppqAmount' };
                readonly ppqCoverage: { readonly column: 'ppqCoverage' };
              };
            };
          };
          readonly TokenPackage: {
          ...
          readonly TokenPurchase: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly amount: { readonly column: 'amount' };
                readonly paymosOrderId: { readonly column: 'paymosOrderId' };
                readonly status: { readonly column: 'status' };
              };
            };
          };
        ...
        readonly enum: {
          readonly TokenPurchaseStatus: {
            ...
            readonly members: readonly [
              ...
              { readonly name: 'PAID_FUNDING'; readonly value: 'PAID_FUNDING' },
            ];
          };
          readonly TokenTransactionType: {
            readonly codecId: 'pg/text@1';
